...
void video_refresh_timer(void *userdata) {
    ...
    if (is->video_st) {
        if (is->pictq_size == 0) {
            ...
            // Now, normally here goes a ton of code about timing, etc. we're just going to guess at a delay for now.
            // You can increase and decrease this value and hard code the timing - but I don't suggest that ;)
