...
int init_sdl(int out_sample_rate, int out_channels, int out_nb_samples, AVCodecContext *pCodecCtx) {
#if USE_SDL
    //Init
...
//    char url[] = "xiaoqingge.mp3";
    ...
    // init sdl
    if (init_sdl(out_sample_rate, out_channels, out_nb_samples, pCodecCtx)) {
