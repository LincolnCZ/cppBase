...
class AddressBook : public ::google::protobuf::Message {
 public:
  ...
  inline int person_info_size() const;
  inline void clear_person_info();
  static const int kPersonInfoFieldNumber = 1;
  inline const ::addressbook::Person& person_info(int index) const;
  inline ::addressbook::Person* mutable_person_info(int index);
  inline ::addressbook::Person* add_person_info();
...
inline void Person_PhoneNumber::set_type(::addressbook::Person_PhoneType value) {
  GOOGLE_DCHECK(::addressbook::Person_PhoneType_IsValid(value));
  set_has_type();
  type_ = value;
}
