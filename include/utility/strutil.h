...
extern void splitLine(const std::string &s, std::vector<std::string> &ret);

extern std::string trim(const std::string &str);

inline bool startWith(const char *str, const char *pattern) {
    return 0 == memcmp(str, pattern, strlen(pattern));
}

inline bool endWith(const char *str, const char *pattern) {
